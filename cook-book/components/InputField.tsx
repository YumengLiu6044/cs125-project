...
export default function InputField({
  ...
  const currentStyle = InputStyles[style];
...
const InputStyles = {
  default: {
    container: {},
    input: { borderWidth: 1, borderColor: Colors.gray[200], backgroundColor: Colors.white },
    Icon: null,
  },
  success: {
    container: {},
    input: { borderWidth: 1, borderColor: Colors.green[500], backgroundColor: Colors.white },
    Icon: <CircleCheck size={20} color={Colors.green[500]} />,
  },
  error: {
    container: {},
    input: { borderWidth: 1, borderColor: Colors.red[500], backgroundColor: Colors.white },
